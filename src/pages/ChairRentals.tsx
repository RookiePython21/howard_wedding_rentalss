...
const chairFaqs = [
  {
    id: 'booking',
    question: 'How far in advance should I book chair rentals?',
    answer:
  ...
  {
    id: 'delivery',
    question: 'Do you deliver, set up, and pick up the chairs?',
    answer:
      'Yes — every rental includes delivery, setup arranged to your layout, and pickup after your event. You won\'t need to lift a finger.',
  },
  {
    id: 'count',
    question: 'How many chairs do I need for my guest count?',
    answer:
      'A good starting point is one chair per guest, plus a handful extra for last-minute additions. We\'ll help you land on the right number when you call.',
  },
  {
    id: 'distance',
  ...
  {
    id: 'damage',
    question: 'What if a chair gets damaged during my event?',
    answer:
...
export default function ChairRentals() {
  return (
    <div className="min-h-screen flex flex-col">
      <SEO
        title="Chair Rentals"
        description="Folding chair rentals for weddings and receptions in Owensboro, KY and surrounding areas. Delivery, setup, and pickup included — call for a free quote."
        image={`${SITE_URL}/images/chair_rental_hero.jpg`}
      />
      <Navbar />
      <main className="flex-1 pt-24 pb-24 md:pb-20">
        ...
        <div className="relative py-24 sm:py-32 overflow-hidden">
          <div
            ...
            style={{ backgroundImage: "url('/images/chair_rental_hero.jpg')" }}
          />
          ...
          <div className="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 text-center">
            ...
            <h1 className="font-playfair text-4xl sm:text-5xl text-white leading-tight mb-5">
              Chair Rentals for Your Wedding Day
            </h1>
            <p className="font-raleway text-white/80 text-base max-w-lg mx-auto mb-8">
              Comfortable folding chairs for your ceremony and reception, delivered and arranged
              exactly where you need them. One call gets you a free, no-obligation quote.
            </p>
            <a
              href="tel:2709035890"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="font-playfair text-3xl sm:text-4xl text-[#2c1f0e] mb-5 leading-tight">
                Folding Chairs, Delivered and Set Up for You
              </h2>
              <p className="font-raleway text-[#6b5744] text-base leading-relaxed mb-6">
                ...
                Whether you need a handful for an intimate gathering or enough for a full guest
                list, we deliver, set up in your layout, and pick everything back up when the
                celebration is over.
              </p>
